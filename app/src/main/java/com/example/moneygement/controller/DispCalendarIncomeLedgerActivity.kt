...
class DispCalendarIncomeLedgerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(ledgerId == 0){
            var intent = Intent(this@DispCalendarIncomeLedgerActivity, MainActivity::class.java)
    ...
    var listener = OnDateChangeListener { view, year, month, dayOfMonth ->
        ...
        //インテント生成
        val intent = Intent(this@DispCalendarIncomeLedgerActivity, InputIncomeHouseholdAccountBookActivity::class.java)
    ...
    override fun onResume() {
        ...
        topButton.setOnClickListener {
            val intent = Intent(this@DispCalendarIncomeLedgerActivity, MainActivity::class.java)
            startActivity(intent)
        }
        val cancel = findViewById<View>(R.id.cancel) as Button
        cancel.setOnClickListener {
            val intent = Intent(this@DispCalendarIncomeLedgerActivity, DispLedgerActivity::class.java)
            startActivity(intent)
        }
    }
}