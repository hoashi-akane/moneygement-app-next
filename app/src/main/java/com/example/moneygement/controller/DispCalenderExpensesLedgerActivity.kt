...
class DispCalenderExpensesLedgerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(ledgerId == 0){
            var intent = Intent(this@DispCalenderExpensesLedgerActivity, MainActivity::class.java)
    ...
    var listener = OnDateChangeListener { view, year, month, dayOfMonth ->
        ...
        //インテント生成
        val intent = Intent(this@DispCalenderExpensesLedgerActivity, InputExpenseHouseholdAccountBookActivity::class.java)
        //年月日を受け渡す
    ...
    override fun onResume() {
        ...
        topButton.setOnClickListener {
            val intent = Intent(this@DispCalenderExpensesLedgerActivity, MainActivity::class.java)
            startActivity(intent)
        }
        val cancel = findViewById<Button>(R.id.cancel)
        cancel.setOnClickListener {
            val intent = Intent(this@DispCalenderExpensesLedgerActivity, DispLedgerActivity::class.java)
            startActivity(intent)
        }
    }
}