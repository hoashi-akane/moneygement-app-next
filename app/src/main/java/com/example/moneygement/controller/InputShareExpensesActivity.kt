...
class InputShareExpensesActivity : AppCompatActivity() {
...
//              保存処理
            ...
            val intent = Intent(this@InputShareExpensesActivity, InputShareExpensesActivity::class.java)
        ...
        saveBtn.setOnClickListener {
            ...
            val intent = Intent(this@InputShareExpensesActivity, DispShareLedgerActivity::class.java)
            startActivity(intent)
        }
        cancelBtn.setOnClickListener {
            val intent = Intent(this@InputShareExpensesActivity, DispShareExpensesCalendarActivity::class.java)
            intent.putExtra("ledgerId", ledgerId)
            startActivity(intent)
        }
    }
